        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configer the settings for HTTP Request node.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Use this name to reference the response of this node in other nodes. For example: {" "} {`{{${watchVariableName}.httpResponse.data}}`}
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
