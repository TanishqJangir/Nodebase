                ...
                {execution.error && (
                        <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
                            ...
                            {execution.errorStack && (
                                ...
                                >
                                    ...
                                    <CollapsibleContent>
                                        <pre className="text-xs text-red-800 font-mono overflow-auto mt-2 p-2 bg-red-200 rounded">
                                            {execution.errorStack}
                                        </pre>
                                    </CollapsibleContent>
                                </Collapsible>
                    ...
                    {execution.output && (
                        <div className="mt-6 p-4 bg-green-50 rounded-md">
                            ...
                            <pre className="text-xs text-green-800 font-mono overflow-auto p-2 bg-green-100 rounded">
